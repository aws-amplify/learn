...
const workshops = [
  {
    ...
    description:
      "In this workshop you'll learn how to build cloud-enabled web applications with Vue & AWS Amplify.",
  ...
  },
  {
    ...
    description:
      "In this workshop you'll learn how to build cloud-enabled web applications with Angular & AWS Amplify.",
  ...
  },
  {
    ...
    description:
      "In this workshop we'll learn how to use Amplify DataStore to create Chatty a single room realtime multi-user chat app using Angular 9 & AWS Amplify.",
  ...
  },
  {
    ...
    description:
      "In this workshop we'll learn how to use Amplify DataStore to create Chatty a single room realtime multi-user chat app using React & AWS Amplify.",
...
const slideDecks = [
  {
    ...
    description:
      'An introduction to the Storage category for AWS Amplify, both the client APIs as well as how to get up and running from the CLI',
    downloadPath: '../../slideDecks/storage.pptx',
    tags: ['Storage', 'Amazon S3'],
  },
  {
    name: 'Auth - Implementing Authentication with AWS Amplify',
    description:
      'A deep dive into the Auth category, mainly focusing on general web implementations.',
  ...
  },
  {
    ...
    description:
      'An overview of the current options and tools for mobile development from AWS Mobile and AWS Amplify.',
  ...
  {
    name:
      'Predictions - Adding Machine Learning to Your Apps with Zero Back End Code',
    description:
      'How to integrate AWS managed machine learning services on your web or mobile app using AWS Amplify.',
  ...
  },
  {
    ...
    description:
      'An in depth look into Amplify DataStore, an persistent on-device storage repository and managed API service.',
